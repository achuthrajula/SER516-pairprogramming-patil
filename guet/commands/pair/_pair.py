...
from ._pair_committers import PairCommittersAction

SET_HELP_MESSAGE = HelpMessageBuilder(
    'guet pair <initials> [<initials>...]', 'Current Pairing strategy').build()


class PairCommittersCommand(CommandFactory):
    ...
    def build(self) -> Step:
        return VersionCheck() \
            ...
            .next(PairCommittersAction(self.committers, self.current))
